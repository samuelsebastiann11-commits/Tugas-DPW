    ...
    <div class="container">
        ...
        <div class="search-container">
            ...
            <form action="index.php" method="get" class="search-form">
                <input type="text" name="cari" placeholder="Cari nama mahasiswa..." value="<?php echo htmlspecialchars($cari); ?>">
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td class="table-actions">
                                <a href="edit.php?id=<?php echo $row['npm']; ?>" class="btn btn-edit">Edit</a>
                                <a href="hapus.php?id=<?php echo $row['npm']; ?>" class="btn btn-delete" onclick="return confirm('Yakin hapus?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
